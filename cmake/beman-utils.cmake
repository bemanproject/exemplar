...
macro(beman_configure_project_option)
  block()
    cmake_parse_arguments(_arg "" "PROJECT;OPTION;TYPE;DEFAULT;DEFAULT_FN;DESCRIPTION" "ENUM" ${ARGN})
    ...
    if(DEFINED _arg_UNPARSED_ARGUMENTS OR DEFINED _arg_KEYWORDS_MISSING_VALUES)
    ...
    set(BEMAN_${_arg_PROJECT}_${_arg_OPTION} "${BEMAN_${_arg_PROJECT}_${_arg_OPTION}}" CACHE ${_arg_TYPE} "${_arg_DESCRIPTION}. Default: ${_arg_DEFAULT}.${_arg_ENUM_STR}")

    if(DEFINED _arg_ENUM)
      set_property(CACHE BEMAN_${_arg_PROJECT}_${_arg_OPTION} PROPERTY STRINGS ${_arg_ENUM})
    endif()
  endblock()
endmacro()
